        ...
        >
            <div className="mx-auto max-w-7xl">
                ...
                <motion.h2
                    ...
                    className="mt-8 w-full bg-gradient-to-b from-foreground to-foreground/30 bg-clip-text text-center font-display leading-none tracking-tight text-transparent text-giga"
                >
                    {footer.bigWord}
                </motion.h2>
                ...
                <div className="mt-14 flex flex-col items-start justify-between gap-6 text-sm md:flex-row md:items-center">
                    <a
                        ...
                        className="inline-flex items-center gap-2 font-mono text-foreground transition-colors hover:text-accent"
                    >
                            ...
                            return (
                                <li key={s.label}>
                                    <a
                                        ...
                                        className="inline-flex items-center gap-2 font-mono text-foreground/80 transition-colors hover:text-accent"
                                    >
