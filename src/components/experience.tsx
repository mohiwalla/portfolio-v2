		...
		>
			...
			>
				<div className="pointer-events-none absolute inset-x-0 top-0 z-20 flex items-start justify-between px-6 pt-10 md:px-12 md:pt-14">
					...
					<div className="text-muted-foreground hidden font-mono text-xs tracking-[0.25em] uppercase md:block">
...
function ExperienceCard({
	...
	return (
		<article
			className="relative flex h-screen w-screen shrink-0 flex-col justify-end px-6 pt-[40vh] pb-28 md:px-20 md:pt-[34vh]"
			aria-label={`${item.company}, ${item.role}`}
		>
			<div className="text-muted-foreground pointer-events-none absolute top-10 right-6 font-mono text-xs tracking-[0.25em] uppercase md:top-16 md:right-20">
				{String(index + 1).padStart(2, "0")} /{" "}
				{String(total).padStart(2, "0")}
			</div>

			<div className="text-muted-foreground mb-5 flex items-center gap-3 font-mono text-xs tracking-[0.2em] uppercase">
			...
			<h3 className="text-mega font-display text-foreground leading-[0.82] wrap-break-word">
				{item.company}
			</h3>
