...
function Pawn() {
    return (
        <svg
            viewBox="0 0 64 96"
            className="h-40 w-40 text-accent drop-shadow-[0_12px_40px_rgba(245,158,11,0.25)]"
            aria-hidden
        >
            <path
                fill="currentColor"
        ...
        <main className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-background px-6">
            ...
            <div className="relative z-10 mx-auto flex w-full max-w-3xl flex-col items-center text-center">
                ...
                <motion.p
                    ...
                    className="mt-8 max-w-xl font-mono text-sm text-muted-foreground"
                >
                    {notFound.body}
                </motion.p>
                ...
                <motion.p
                    ...
                    className="mt-12 font-mono text-[11px] tracking-[0.3em] text-muted-foreground/70 uppercase"
                >
                    404 · off the board
                </motion.p>
            </div>
