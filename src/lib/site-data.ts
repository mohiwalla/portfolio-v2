...
const siteData: SiteData = {
	...
	experience: [
		{
			...
			punchline:
				"i basically connect boxes to other boxes and hope for the best.",
		},
		{
			...
			punchline:
				"my first real rodeo. learned a lot. broke a few things. fixed them.",
		},
	],
	skills: [
		"TypeScript",
	...
	projects: [
		{
			...
			description:
				"it uses bun and typescript to boss around a resume renderer and chrome, turning my ramblings into a pdf that hopefully beats the ats bots. this resume was made with it.",
			tags: ["bun", "typescript", "cli", "automation"],
		...
		},
		{
			...
			description:
				"a full-stack platform to run a teaching institute, from student sign-ups to paying the teachers. it does everything but make the coffee.",
		...
		},
		{
			...
			description:
				"a work-in-progress cli to scaffold a whole agentic dev setup. it hooks into azure, clockify, and other things i use daily. mostly for me, but you can watch.",
			tags: ["bun", "typescript", "cli", "react ink", "wip"],
			href: "https://github.com/mohiwalla",
			status: "in-progress",
		},
		{
			...
			description:
				"a web-based macos clone i'm tinkering with. it has a boot screen, a dock, and you can drag windows around. why? because i could.",
			tags: ["react", "typescript", "css", "wip"],
			status: "in-progress",
		},
		{
			name: "dtquick",
			...
			description:
				"one of my first real javascript projects. it's a lightweight table library published to npm. a bit crusty, but we all start somewhere, right?",
			tags: ["javascript", "npm", "legacy"],
		...
		},
		{
			...
			description:
				"built with vite and react, with a sprinkle of framer motion. it's got scroll hijacking and a few secrets. don't break it.",
			tags: ["react", "vite", "framer motion", "easter eggs"],
			status: "shipped",
		},
	],
	teaser: {
	...
	footer: {
		...
		signoff:
			"built with caffeine and a general disregard for my own sleep schedule.",
	},
	terminal: {
		greeting: ["mohiwallaOS v1.0.0", "type 'help' to see what you can do."],
		commands: [
			{
				cmd: "whoami",
				response: [
			...
			{
				cmd: "konami",
				response: ["nice try. but you have to actually *do* it."],
			},
			{
				cmd: "help",
				response: [
		...
		fallback:
			"command not found. are you making things up again? type 'help'.",
	},
	konami: {
